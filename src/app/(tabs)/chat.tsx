    ...
    <SafeAreaView style={styles.root} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <View style={styles.iconBtn}><Text style={styles.iconBtnTxt}>🔍</Text></View>
          <View style={styles.iconBtn}><Text style={styles.iconBtnTxt}>✏️</Text></View>
        </View>
      </View>
            ...
            <View style={styles.chatInfo}>
              <View style={styles.chatTop}>
                <View style={styles.chatNameRow}>
                  ...
                  {c.muted && <Text style={styles.mutedIcon}>🔕</Text>}
                </View>
              ...
              <View style={styles.chatBottom}>
                <Text style={[styles.chatLast, c.locked && styles.chatLastMuted]} numberOfLines={1}>
                  {c.locked && '🔒 '}
                  {c.gift && <Text style={styles.giftText}>🎁 </Text>}
                  {c.last}
                </Text>
                {c.unread > 0 && (
...
const styles = StyleSheet.create({
  ...
  giftText: { color: Colors.goldDeep },
